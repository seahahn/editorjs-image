...
- Allows hiding an image caption
...
```shell
yarn add @seahahn/editorjs-image
```

Include module at your application

```javascript
import ImageTool from "@seahahn/editorjs-image";
```
...
| hideCaption    | `boolean` | hide caption of the image                                                                 |
